            ...
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    {isAuth === true ? (
                        ...
                        {' '}
                        <li>
                            <a><Link to='/logout' className='p-2'><i class="ri ri-check"></i> <span>Logout</span></Link></a>
                        </li>
                        </Fragment>
                    ) : (
                        <Fragment>
                        {' '}
                        <li>
                            <a><Link to='/login'><i class="ri ri-check"></i> <span>Login</span></Link></a>
                        </li>
                        <li>
                            <a><Link to='/signup' className='p-2'><i class="ri ri-check"></i> <span>Signup</span></Link></a>
                        </li>
                        </Fragment>
                    )}
